...
from astrokit.ephem import Ephem
from astrokit.frames import Planes
import astrokit.plotting.orbit.backends as orbit_plotter_backends
from astrokit.plotting.util import BODY_COLORS, generate_label
from astrokit.twobody.mean_elements import get_mean_elements
from astrokit.twobody.sampling import EpochBounds
from astrokit.util import norm, time_range
...
class OrbitPlotter:
    ...
    def __init__(
        ...
        *,
        ...
        Parameters
        ----------
        backend : ~astrokit.plotting.orbit.backends._base.OrbitPlotterBackend
        ...
        plane : ~astrokit.frames.Plane, optional
    ...
    def backend(self):
        ...
        Returns
        -------
        ~astrokit.plotting.orbit.backends._base.OrbitPlotterBackend
    ...
    def plane(self):
        ...
        Returns
        -------
        ~astrokit.frames.Plane, optional
            Reference plane to be used when drawing the scene. Default to
    ...
    def set_attractor(self, attractor):
        ...
        Parameters
        ----------
        attractor : ~astrokit.bodies.Body
            Central body.
    ...
    def set_orbit_frame(self, orbit):
        ...
        Parameters
        ----------
        orbit : ~astrokit.twobody.orbit.Orbit
    ...
    def set_body_frame(self, body, epoch=None):
        ...
        Parameters
        ----------
        body : ~astrokit.bodies.SolarSystemPlanet
            Body.
    ...
    def plot_maneuver(
        ...
        Parameters
        ----------
        initial_orbit : ~astrokit.twobody.orbit.Orbit
            The base orbit for which the maneuver will be applied.
        maneuver : ~astrokit.maneuver.Maneuver
