...
from astrokit.core.elements import coe2mee, coe2rv, mee2coe, mee2rv, rv2coe
from astrokit.twobody.elements import mean_motion, period, t_p
...
class BaseState:
    ...
    def __init__(self, attractor, elements, plane):
        ...
        plane : ~astrokit.frames.enums.Planes
